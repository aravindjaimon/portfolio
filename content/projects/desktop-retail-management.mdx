...
As Full Stack Developer on a team of 3, I rebuilt a critical desktop application for a retail chain managing hundreds of stores. The legacy Electron-based POS client suffered from slow synchronization and high memory usage, directly impacting store operations and causing inventory discrepancies.
...
- Rebuilt using Tauri with Rust backend for an ~80% smaller binary and better performance
