...
export const storyMilestones: StoryMilestone[] = [
  {
    ...
    date: "October 2020",
    description:
      "Joined as the FIRST engineer at RaftLabs. Started with nothing but vision and code.",
  },
  {
    phase: "THE BUILDING",
    date: "2020-2022",
    description:
      "Established technical culture, coding standards, architectural roadmap. Every system, every pattern, every decision — built from scratch.",
  },
  {
    phase: "THE SCALING",
    date: "2022-2024",
    description:
      "1 → 30+ engineers. Mentored 10+ developers. Created the engineering DNA that powers the company today.",
  },
  {
    phase: "THE IMPACT",
    date: "2024-Present",
    description:
      "1M+ users served. 10,000 events/minute processed. 97% performance improvements delivered. 50+ production systems shipped.",
  },
];
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    keyDecisions: [
      {
        decision: "PostgreSQL with pgvector over dedicated vector DB",
        reasoning:
      ...
      {
        decision: "Admin panel for knowledge management",
        reasoning:
  ...
  },
  {
    ...
    keyDecisions: [
      ...
      {
        decision: "Operational Transform for conflicts",
        reasoning: "Predictable conflict resolution that preserves user intent",
      },
    ],
    results: [
  ...
  },
  {
    ...
    keyDecisions: [
      {
        decision: "Next.js ISR over traditional SSR",
        reasoning:
          "Static generation with revalidation balanced freshness with performance",
      },
      {
        decision: "Vercel Edge Network over custom CDN",
        reasoning:
...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    company: "Techtonic",
    highlights: ["React-Gatsby development", "Three.js 3D experiences"],
  },
  {
    period: "2019",
    role: "Python Developer Intern",
    company: "Vaultboard",
    highlights: ["Resume parsing algorithms", "Automation development"],
  },
];
